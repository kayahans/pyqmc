...
import time
import numpy as np
from pyqmc.observables import energy
...
from pyqmc.wf.bosonslater import timer_func

from pyqmc.observables.accumulators import PGradTransform

# --- optional boson DMC / ABCDMC wall-clock profiling (env or pyqmc.method.boson_profile_config) ---
...
def configure_boson_dmc_profiling(enabled=None, print_every=None):
    """Set profiling from ``config.yaml`` (recommended on batch systems). See ``pyqmc.method.boson_profile_config``."""
